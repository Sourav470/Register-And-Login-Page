...
root = Tk()
connection = mysql.connector.connect(host='localhost', user='root', port='3308', password='', database='py_lg_rg_db')
c = connection.cursor()
...
headerframe = tk.Frame(root, highlightbackgroun='yellow', highlightcolor='yellow', highlightthickness=2, bg='#95a5a6',
                       width=w, height=70)
...
login_contentframe = tk.Frame(loginframe, padx=30, pady=100, highlightbackgroun='yellow', highlightcolor='yellow',
...
go_register_label = tk.Label(login_contentframe, text=">> don't have an account? create one", font=('Verdana', 10),
                             bg=bgcolor, fg='red')
...
register_contentframe = tk.Frame(registerframe, padx=15, pady=15, highlightbackgroun='yellow', highlightcolor='yellow',
                                 highlightthickness=2, bg=bgcolor)
...
image_label_rg = tk.Label(register_contentframe, text='Profile Pic:', font=('Verdana', 14), bg=bgcolor)
...
imagepath_label_rg = tk.Label(selectimage_frame, text='image path...', bg=bgcolor, width=22)

register_button = tk.Button(register_contentframe, text="Register", font=('Verdana', 16), bg='#2980b9', fg='#fff',
                            padx=25, pady=10, width=25)

go_login_label = tk.Label(register_contentframe, text=">> already have an account? sign in", font=('Verdana', 10),
                          bg=bgcolor, fg='red')
...
def select_image():
    filename = filedialog.askopenfilename(initialdir='/images', title="Select Profile Picture",
